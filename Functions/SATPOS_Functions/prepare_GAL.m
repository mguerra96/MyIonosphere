...
ephe_tab(32,1)=ephe.DataSources;
ephe_tab(33,1)=ephe.GALWeek;
ephe_tab(34,1)=ephe.BRDCOrbit5Spare4;
ephe_tab(35,1)=ephe.SISAccuracy;
ephe_tab(36,1)=ephe.SVHealth;
ephe_tab(37,1)=ephe.BGDE5aE1;
ephe_tab(38,1)=ephe.BGDE5bE1;
ephe_tab(39,1)=ephe.TransmissionTime;
ephe_tab(40,1)=ephe.BRDCOrbit7Spare2;
ephe_tab(41,1)=ephe.BRDCOrbit7Spare3;
ephe_tab(42,1)=ephe.BRDCOrbit7Spare4;

fieldname=['E' num2str(sat,'%02d')];
GALNav.(fieldname)=ephe_tab;
