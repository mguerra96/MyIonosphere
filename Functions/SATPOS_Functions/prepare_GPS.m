...
ephe_tab(32,1)=ephe.L2ChannelCodes;
ephe_tab(33,1)=ephe.GPSWeek;
ephe_tab(34,1)=ephe.L2PDataFlag;
ephe_tab(35,1)=ephe.SVAccuracy;
ephe_tab(36,1)=ephe.SVHealth;
ephe_tab(37,1)=ephe.TGD;
ephe_tab(38,1)=ephe.IODC;
ephe_tab(39,1)=ephe.TransmissionTime;
ephe_tab(40,1)=ephe.FitInterval;
ephe_tab(41,1)=ephe.BRDCOrbit7Spare3;
ephe_tab(42,1)=ephe.BRDCOrbit7Spare4;

fieldname=['G' num2str(sat,'%02d')];
GPSNav.(fieldname)=ephe_tab;
